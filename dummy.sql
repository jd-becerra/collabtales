...
INSERT INTO Alumno (nombre, contrasena, correo) VALUES 
('Juan Perez', '$2y$10$eImG9m6MvntXJ4O27hdXHOzVZ49L4g7t2xz4zR0AqYSm7ZXO8G3y6', 'juan.perez@example.com'),
('Maria Lopez', '$2y$10$h1Q3Zv3x57Uxy3Dk9EZsfuhKzCZ9RYkaY0QykLfYRT2qvlWXTW.eS', 'maria.lopez@example.com'),
('Carlos Gomez', '$2y$10$0tFZ0ZhDf0KpX06Iq7EdGe3ql1Pp0OnZsG3XaY6T0WGyKl2tV8QfS', 'carlos.gomez@example.com'),
('Ana Martinez', '$2y$10$F9/dK/NOdS3H3Hq5jNmLxOxZ5hsyXtNwVmfgKvH6rHcCm5DTjzJr6', 'ana.martinez@example.com'),
('Luis Rodriguez', '$2y$10$z6vJ9iQbcfRb2tx38MwbqO5UZX3x89wytn.zqF15XT3kjmbULMcPO', 'luis.rodriguez@example.com');
...
(1, 1), (2, 1), (3, 2), (4, 2), (5, 3), (1, 3), (2, 4), (3, 4), (4, 5), (5, 5);

-- Insertar Aportaciones en formato JSON

<template>
  <v-card class="dialog-card">
      ...
      <p class="ocultar-cuento-subheader text-caption mb-6">¿Estás seguro de querer ocultar este cuento? El cuento ya no estará disponible de manear pública y solo los usuarios que son colaboradores en el cuento podrán verlo.</p>
